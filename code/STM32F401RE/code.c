...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
int _write(int file, char *ptr, int len)	//con questa funzione possiamo abilitare tutti i nostri canali
{
	int i=0;
...
HAL_TIM_IC_Start_IT(&htim4, TIM_CHANNEL_1);
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  distanza = (fallingEdgeTime)* velocita/2000000;		//la fornisco in metri
	  printf("distanza: %.3f",distanza);
